...
public class ItemUtils {
     ...
     */
    public static boolean compare(ItemStack first, ItemStack second, ItemData... datas) {
        if (first == second) {
            return true;
        }
    ...
    public static int count(Inventory inv, Material type) {
        return count(inv, new ItemStack(type), (a, b) -> compare(a, b, ItemData.TYPE));
    }
    ...
    public static boolean remove(Inventory inv, Material type, int amount) {
        return remove(inv, new ItemStack(type), amount, (a, b) -> compare(a, b, ItemData.TYPE));
    }
    ...
    public static int countAndRemove(Inventory inv, Material type, int max) {
        return countAndRemove(inv, new ItemStack(type), max, (a, b) -> compare(a, b, ItemData.TYPE));
    }
    ...
    public static int countAndRemove(Inventory inv, Material type) {
        return countAndRemove(inv, new ItemStack(type), Integer.MAX_VALUE, (a, b) -> ItemUtils.compare(a, b, ItemData.TYPE));
    }
